...
@Component({
  selector: 'app-leftBar_after_login',
  templateUrl: './leftBar_after_login.component.html',
  styleUrls: ['./leftBar_after_login.component.css']
})



export class LeftBar_after_loginComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    var pageUrl_Aray = this.router.url.split("/");
    this.getPageURL = pageUrl_Aray[1];

    // if(this.getPageURL == 'profile_list'){
    //   console.log(this.getPageURL == 'profile_list', 'this.currentUrl');
    // }

    // this.progressValue = localStorage.getItem("progressValue");
...
// return localStorage.setItem("progressValue", JSON.stringify(Math.round(incrementItem + defaultValue)))
